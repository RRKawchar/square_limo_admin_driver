...
class CancelDetailsSection extends StatelessWidget {
  final int index;
  final ACancelViewModel cancelViewModel;
  const CancelDetailsSection({super.key, required this.cancelViewModel, required this.index,});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height:
          cancelViewModel.isSeeDetails[index] ? 8 : 15,
        ),
        cancelViewModel.isSeeDetails[index]
            ? Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
